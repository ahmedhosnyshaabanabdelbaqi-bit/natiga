...
| `GET` | `/api/v1/delivery-notes` | delivery_note.view |
| `POST` | `/api/v1/delivery-notes` | delivery_note.create |
| `GET` | `/api/v1/delivery-notes/{id}` | delivery_note.view |
| `POST` | `/api/v1/delivery-notes/{id}/cancel` | delivery_note.cancel |
| `POST` | `/api/v1/delivery-notes/{id}/confirm` | delivery_note.update |
| `POST` | `/api/v1/delivery-notes/{id}/dispatch` | delivery_note.post |
| `POST` | `/api/v1/delivery-notes/{id}/fail` | delivery_note.update |
...
| `GET` | `/api/v1/sales-orders` | sales_order.view |
| `POST` | `/api/v1/sales-orders` | sales_order.create |
| `GET` | `/api/v1/sales-orders/credit-check` | sales_order.view |
| `GET` | `/api/v1/sales-orders/{id}` | sales_order.view |
| `PATCH` | `/api/v1/sales-orders/{id}` | sales_order.update |
| `POST` | `/api/v1/sales-orders/{id}/approve` | sales_order.approve |
| `POST` | `/api/v1/sales-orders/{id}/cancel` | sales_order.cancel |
| `POST` | `/api/v1/sales-orders/{id}/close` | sales_order.approve |
