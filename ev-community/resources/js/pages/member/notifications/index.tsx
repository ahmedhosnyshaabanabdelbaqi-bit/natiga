...
import { index, read, readAll, unreadCount } from '@/routes/member/notifications';
...
MemberNotifications.layout = () => ({ breadcrumbs: [{ title: t('notifications.center.title'), href: index.url() }] });
