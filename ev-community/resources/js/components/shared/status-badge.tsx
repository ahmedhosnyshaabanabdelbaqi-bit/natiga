...
const toneClasses: Record<StatusTone, string> = {
    success:
        'border-transparent bg-success-soft text-success dark:text-success-foreground dark:bg-success/80',
    warning:
        'border-transparent bg-warning-soft text-warning dark:text-warning-foreground dark:bg-warning/80',
...
export function StatusBadge({
    ...
    return (
        <Badge
            variant="outline"
            className={cn('capitalize', toneClasses[resolved], className)}
            data-status={status}
        >
