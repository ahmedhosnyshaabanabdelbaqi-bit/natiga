            ...
            action={
                onReset ? (
                    <button
                        type="button"
                        onClick={onReset}
                        className="rounded-sm text-sm font-medium text-brand underline-offset-4 outline-none hover:underline focus-visible:ring-2 focus-visible:ring-ring/60"
                    >
