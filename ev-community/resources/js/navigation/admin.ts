        ...
        },
        {
            ...
            items: [
                ...
                { title: t('admin.nav.support'), href: '/admin/support', icon: LifeBuoy, permission: ['support.view'] },
                {
                    ...
                    children: [
                        { title: t('notifications.admin.campaigns'), href: '/admin/notifications', permission: ['notifications.view', 'notifications.manage'] },
                        { title: t('notifications.admin.deliveries'), href: '/admin/notifications/deliveries', permission: ['notifications.view', 'notifications.manage'] },
                        { title: t('notifications.admin.templates'), href: '/admin/notifications/templates', permission: ['notifications.view', 'notifications.manage'] },
                        { title: t('notifications.admin.inbox'), href: '/admin/notifications/inbox' },
                    ],
                },
