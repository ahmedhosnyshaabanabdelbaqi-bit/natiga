...
export function ReferralStatusBadge({ status }: { status: ReferralStatus }) {
    return (
        <StatusBadge
            ...
            label={t(`referrals.status.${status}`)}
        />
    );
}
...
export function DeletionStatusBadge({
    ...
    return (
        <StatusBadge
            status={status}
            tone={tone}
            label={t(`privacy.deletion.status.${status}`)}
        />
    );
}
...
export function VerificationResultBadge({
    ...
    return (
        <StatusBadge
            status={result}
            tone={verificationTones[result]}
            label={t(`members.verification.result.${result}`)}
        />
    );
}
