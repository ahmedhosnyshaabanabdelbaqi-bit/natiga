...
export function pick(label: LocalizedLabel | string | null | undefined): string {
    if (!label) {
        return '';
    }
...
export function tOr(key: string, fallback: string, replacements: Record<string, string | number> = {}): string {
