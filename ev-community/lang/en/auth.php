...
return [
    ...
    'fields' => ['name' => 'Name', 'email' => 'Email', 'mobile' => 'Mobile number', 'password' => 'Password', 'terms' => 'Terms acceptance', 'invitation_code' => 'Invitation code'],
    'login' => [
    ...
    'forgot' => ['title' => 'Forgot password', 'description' => 'Enter your email to receive a password reset link', 'submit' => 'Email reset link', 'back' => 'Back to log in'],
    'reset' => ['title' => 'Reset password', 'submit' => 'Save password'],
    'verify' => ['title' => 'Verify your email', 'description' => 'We sent a verification link to your email. If you did not receive it, you can resend it.', 'resend' => 'Resend', 'sent' => 'A new verification link has been sent.'],
    'two_factor' => ['title' => 'Two-factor authentication', 'description' => 'Enter the code from your authenticator app', 'recovery' => 'Use a recovery code', 'use_code' => 'Use an authentication code', 'submit' => 'Continue', 'required_title' => 'Two-factor authentication required', 'required_description' => 'Your role requires TOTP two-factor authentication before using the admin panel.', 'setup' => 'Set up two-factor authentication'],
    'confirm_password' => ['title' => 'Confirm password', 'description' => 'This is a secure area. Please confirm your password to continue.'],
